...
import { CoachAppMenu } from './coach-app-menu';

@Component({
    selector: 'coach-menu',
    standalone: true,
    imports: [CommonModule, CoachAppMenu],
    template: `
        <div class="layout-sidebar" [class.sidebar-visible]="isSidebarVisible">
            <div class="sidebar-logo">
                ...
                <span class="logo-text">Mon<br/>Équipe</span>
            </div>
            <coach-app-menu></coach-app-menu>
        </div>
        <!-- Overlay pour mobile -->
        <div
            class="layout-mask"
...
export class CoachMenuComponent implements OnInit {
    ...
    ngOnInit() {
        // Le menu est géré par CoachAppMenu
    }
