...
import { ClubMenuComponent } from './club.menu';

@Component({
    selector: 'club-layout',
    standalone: true,
    imports: [CommonModule, AppTopbar, ClubMenuComponent, RouterModule, AppFooter],
    styles: [`
      .route-overlay {
        position: fixed;
        inset: 0;
    ...
    template: `<div class="layout-wrapper" [ngClass]="containerClass">
        ...
        <club-menu [ngClass]="{ 'blurred': isNavigating }"></club-menu>
...
export class ClubLayout implements OnDestroy {
    ...
    @ViewChild(ClubMenuComponent) appSidebar!: ClubMenuComponent;
